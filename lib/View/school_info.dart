...
class SchoolInfo extends StatelessWidget {
  ...
  builder: (context, schoolViewModel,widget) {
    return Column(
          ...
          children: [
            ...
            reusableTextField(schoolViewModel.schoolModel?.schoolName??"School Name", Icons.school),
            const SizedBox(height: 15,),
            reusableTextField(schoolViewModel.schoolModel?.schoolAddress??"School Address", Icons.location_on_rounded),
            const SizedBox(height: 15,),
            reusableTextField(schoolViewModel.schoolModel?.numberOfStudents??"Number Of Students", Icons.person),
            const SizedBox(height: 15,),
            reusableTextField(schoolViewModel.schoolModel?.numberOfTeachers??"Number Of Teachers", Icons.person),
            Padding(
              ...
              child: Container(
                  ...
                  child: Padding(
                    ...
                    child: ButtonTheme(
                      ...
                      child: schoolViewModel.loading?Center(child: CircularProgressIndicator(color: Colors.white,),): TextButton(
                        onPressed: () {
                          ...
                          schoolViewModel.getSchoolData(context);
                        },
                        child: Text(
                          'Show Data',
                          style: TextStyle(
      ...
      child: Container(
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 10,),
            Text(
              text, style: const TextStyle(color: Colors.white, fontSize: 25),),
          ],
        ),
      ),
    );
